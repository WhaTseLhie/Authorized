    ...
    public void onClick(View v) {
        switch(v.getId()) {
            case R.id.imageView:
                ...
                break;
            case R.id.btnAddID:
                if(ActivityCompat.checkSelfPermission(AddRepActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(AddRepActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 100);
                    return;
                }
                Intent intent = new Intent(AddRepActivity.this, CustomPhotoGalleryActivity.class);

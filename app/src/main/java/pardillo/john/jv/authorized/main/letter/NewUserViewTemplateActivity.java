...
public class NewUserViewTemplateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_user_view_template);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.use:
                ...
                Intent createLetter = new Intent(this, NewUserCreateLetterActivity.class);

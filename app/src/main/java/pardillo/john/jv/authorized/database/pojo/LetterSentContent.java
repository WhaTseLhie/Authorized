...
public class LetterSentContent {
    ...
    public LetterSentContent(int lc_id, String c_name, String c_type, int c_leftMargin, int c_topMargin, int c_rightMargin, int c_bottomMargin, int c_id, int t_id, int a_id, int s_id, int r_id) {
        this.lc_id = lc_id;
        this.c_name = c_name;
        this.c_type = c_type;

...
public class AdminAddTemplateActivity extends AppCompatActivity implements View.OnClickListener {
...
//    private ArrayList<TemplateContent> contentList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_add_template);
            ...
            case R.id.btnSave:
                ...
                if(TextUtils.isEmpty(t_title) || TextUtils.isEmpty(t_type)) {
                    ...
                    for(int i=0; i<mcList.size(); i++) {
                        ...
                        ////////////////////////////////////////////
                        Log.d("addTemplateContent", mcList.get(i).getMc_name()+","+mcList.get(i).getMc_type()+", 4zeroes ,"+t_id+"");
                        ////////////////////////////////////////////
                    }

                    ////////////////////////////////////////////
                    Log.d("addTemplateDetails", t_title+","+t_date+","+t_type+","+userList.get(0).getA_id()+"");
                    ////////////////////////////////////////////
                    ...
                    Intent finishIntent = new Intent(this, AdminFinishTemplateActivity.class);

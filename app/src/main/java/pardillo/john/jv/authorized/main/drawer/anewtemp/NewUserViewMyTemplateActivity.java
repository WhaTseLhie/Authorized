...
public class NewUserViewMyTemplateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_user_view_my_template);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()) {
            case R.id.shared:
                ...
                break;
            case R.id.update:
                Intent updateTemplate = new Intent(this, NewUserUpdateTemplateActivity.class);
            ...
            case R.id.delete:
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        NewUserViewMyTemplateActivity.this.setResult(Activity.RESULT_OK, intent);
                        NewUserViewMyTemplateActivity.this.finish();
                    }
                });
